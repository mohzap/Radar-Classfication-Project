...
MODEL_PATH = 'C:\\Users\\Mohamed Zahier\\Documents\\UCT\\4th year\\EEE4022S\\Thesis\\Code\\GitHub\\CNN-LSTM\\LSTM_Model_Tester\\Model\\LSTM_model.pt'
    ...
    with torch.no_grad():
        for data in loader:
            ...
            for i in range(0,len(y)):
                if(y[i]!=y_pred[i]):
                    x_inc = torch.cat([x_inc,torch.squeeze(x[i],1).cpu()], 0)                   
