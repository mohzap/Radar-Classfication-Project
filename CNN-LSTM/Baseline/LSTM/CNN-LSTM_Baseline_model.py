...
#Model save location
MODEL_STORE_PATH = 'C:\\Users\\Mohamed Zahier\\Documents\\UCT\\4th year\\EEE4022S\\Thesis\\Code\\GitHub\\CNN-LSTM\\Baseline\\Model'
...
class LSTM1(nn.Module):
    def __init__(self):
        ...
        self.layer3 = nn.Sequential(
            ...
            nn.ReLU())
        self.layer4 = nn.LSTM(input_size=128, hidden_size=self.hidden_dim, num_layers=self.n_layers ,batch_first=True)
    ...
    def forward(self, x):
        ...
        r_in= c_out3.view(batch_size, -1, H)
        r_out,self.hidden_cell = self.layer4(r_in,self.hidden_cell)
...
for epoch in range(num_epochs):
    ...
    for i, (images, labels) in enumerate(train_loader):
        #Initailise the intial hidden and cell state of the minibatch examples
...
print('Test Accuracy of the model: {} %'.format(test_acc* 100))
